...
public class Pawn : MonoBehaviour
{
    ...
    { 
        ...
        if (pawn.layer == 6)
        {
            ...
            if (do3D)
            {
                Collider[] intersectingC = Physics.OverlapSphere(new Vector3(pos.x, pos.y + 1.75f, pos.z), 0.01f);
                Collider[] intersectingD = Physics.OverlapSphere(new Vector3(pos.x, pos.y + 3.5f, pos.z), 0.01f);
                if (pos.y == 0 && pos.z == 1 && intersectingD.Length == 0 && pos.y <= 8.75)
                {
                    moves.Add(new Vector3(pos.x, pos.y + 1.75f, pos.z));
                    moves.Add(new Vector3(pos.x, pos.y + 3.5f, pos.z));
                }
                else if (intersectingC.Length == 0 && pos.y <= 10.5)
                {
                    moves.Add(new Vector3(pos.x, pos.y + 1.75f, pos.z));
                }
            }
        ...
        else
        {
            ...
            if (do3D)
            {
                Collider[] intersectingC = Physics.OverlapSphere(new Vector3(pos.x, pos.y + 1.75f, pos.z), 0.01f);
                Collider[] intersectingD = Physics.OverlapSphere(new Vector3(pos.x, pos.y + 3.5f, pos.z), 0.01f);
                if (pos.y == 0 && pos.z == 6 && intersectingD.Length == 0 && pos.y <= 8.75)
                {
                    moves.Add(new Vector3(pos.x, pos.y + 1.75f, pos.z));
                    moves.Add(new Vector3(pos.x, pos.y + 3.5f, pos.z));
                }
